...
pub static ICON_LIST: Lazy<HashMap<&'static str, Icon>> = Lazy::new(|| {
	...
	icons.insert(
		...
		Icon {
			...
			stroke_linecap: None,
			stroke_linejoin: None,
			nodes: vec!["<path d=\"M12 18a6 6 0 1 0 0-12 6 6 0 0 0 0 12Z\"/>"],
		},
	);
	...
	icons.insert(
		...
		Icon {
			...
			stroke_linecap: None,
			stroke_linejoin: None,
			nodes: vec!["<path d=\"M8 4a4 4 0 1 1 0 8 4 4 0 0 1 0-8Z\"/>"],
		},
	);
	...
	icons.insert(
		...
		Icon {
			...
			stroke_linecap: None,
			stroke_linejoin: None,
			nodes: vec!["<path d=\"M6 0a6 6 0 1 1 0 12A6 6 0 0 1 6 0Zm3 5H3v2h6Z\"/>"],
		},
	);
