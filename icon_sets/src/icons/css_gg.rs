...
pub static ICON_LIST: Lazy<HashMap<&'static str, Icon>> = Lazy::new(|| {
	...
	icons.insert(
		...
		Icon {
			...
			stroke_linecap: "",
			stroke_linejoin: "",
			nodes: vec!["<path d=\"M7 7H17V17H7V7Z\" fill=\"currentColor\"/>"],
		},
	);
	...
	icons.insert(
		...
		Icon {
			...
			stroke_linecap: "",
			stroke_linejoin: "",
			nodes: vec!["<path d=\"M2 11H22V13H2V11Z\" fill=\"currentColor\"/>"],
		},
	);
	...
	icons.insert(
		...
		Icon {
			...
			stroke_linecap: "",
			stroke_linejoin: "",
			nodes: vec!["<path d=\"M15 5H5V15H9V19H19V9H15V5Z\" fill=\"currentColor\"/>"],
		},
	);
