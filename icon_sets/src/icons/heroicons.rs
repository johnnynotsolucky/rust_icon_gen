...
pub static ICON_LIST: Lazy<HashMap<&'static str, Icon>> = Lazy::new(|| {
	...
	icons.insert(
		...
		Icon {
			...
			stroke_linecap: None,
			stroke_linejoin: None,
			nodes: vec!["<g clip-path=\"url(#a)\"/>", "<defs/>"],
		},
	);

	icons.insert(
		"ArrowLeftEndOnRectangleMini",
		Icon {
			view_box: "0 0 20 20",
			class: None,
			width: None,
	...
	icons.insert(
		"ArrowRightStartOnRectangleMini",
		Icon {
			view_box: "0 0 20 20",
			class: None,
			width: None,
	...
	icons.insert(
		...
		Icon {
			...
			stroke_linecap: None,
			stroke_linejoin: None,
			nodes: vec!["<path d=\"M6.75 9.25a.75.75 0 0 0 0 1.5h6.5a.75.75 0 0 0 0-1.5h-6.5Z\"/>"],
		},
	);
	...
	icons.insert(
		"ArrowLeftEndOnRectangleOutline",
		Icon {
			view_box: "0 0 24 24",
			class: None,
			width: None,
	...
	icons.insert(
		"ArrowRightStartOnRectangleOutline",
		Icon {
			view_box: "0 0 24 24",
			class: None,
			width: None,
